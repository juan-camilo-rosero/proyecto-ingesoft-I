...
function CTA() {
  return (
    <section className="px-8 pb-20 md:px-16">
        <div className="bg-tblue-700 rounded-xl min-h-20 p-8 text-black md:px-16 lg:py-12">
            <h3 className="text-center font-semibold text-2xl md:text-3xl lg:mx-auto lg:text-4xl lg:w-4/5">Empieza ahora a usar Talkie</h3>
